...
TrnData1 = TrnData(:,1:4:end);  % sample around 2500 training samples
...
fprintf('\n ====== PCANet Training ======= \n')
TrnData_ImgCell = mat2imgcell(TrnData1,ImgSize,ImgSize,ImgFormat); % convert columns in TrnData to cells 
